...
public class Jayanagar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jayanagar);
        ...
        text4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("tel:9620632260"));//implicit intent
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Jayanagar.this, ClickedImage.class);
                startActivity(intent);
            }
        });
...
//                Intent intent = new Intent(bottom_sheet.this, MapsActivity.class);
//            startActivity(intent);
        });
        ...
        text1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Jayanagar.this, page1.class);
                startActivity(intent);
            }
        });
